...
export const stageSchemas: StageSchema[] = [
  ...
  },
  {
    ...
    outputs: ['tech-stack.json', 'ai-context.md', 'readiness-report.md', 'project-architecture.md', 'implementation-checklist.md'],
    fields: [
      { id: 'output.assets.selected', label: '正式輸出', type: 'multi_select', required: true, section: '正式輸出', ownerRoles: ['system'], description: '選擇要產出的正式文件。', options: [{ value: 'tech-stack.json', label: 'tech-stack.json' }, { value: 'ai-context.md', label: 'ai-context.md' }, { value: 'readiness-report.md', label: 'readiness-report.md' }, { value: 'project-architecture.md', label: 'project-architecture.md' }, { value: 'implementation-checklist.md', label: 'implementation-checklist.md' }] },
    ],
  },
  {
    key: 's7',
